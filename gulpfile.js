...
function source() {
  return project.splitSource()
    ...
    .pipe(gulpif('**/*.{png,gif,jpg,svg,webp}', images.minify()))
    .pipe(gulpif(/\.html$/, htmlMinifier({
      removeComments: true,
      collapseWhitespace: true, //TODO: If you preserve the space betwen tag elements use conservativeCollapse: http://perfectionkills.com/experimenting-with-html-minifier/#collapse_whitespace
...
function dependencies() {
  return project.splitDependencies()
    .pipe(gulpif(/\.html$/, htmlMinifier({
      removeComments: true,
      collapseWhitespace: true, //TODO: If you preserve the space betwen tag elements use conservativeCollapse
      conservativeCollapse: false,
      minifyJS: true,
      minifyCSS: true
    })))
